      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {STAT_DEFS.map((def, i) => {
          ...
          return (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${def.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />

              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <div className={`flex h-10 w-10 items-center justify-center rounded-xl ${def.tone} transition-transform duration-300 group-hover:scale-110`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-border/40 bg-gradient-to-br from-success/5 via-card to-card p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:border-success/30">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Your hiring funnel at a glance
            </p>
